  ...
  <main class="container p-4 md:px-8 lg:px-16">
    <section class="mt-20 flex flex-col-reverse gap-8 justify-between items-center sm:flex-row">
      <div class="flex flex-col gap-4">
        <pre class="whitespace-pre-line font-bold text-xl md:text-2xl font-sans text-[#42446E] dark:text-gray-200">
          Olá 👋,
          Meu nome é
        ...
        <a href="/CV-Thiago_Andrade.pdf" download="CV-Thiago_Andrade.pdf">
          <button
            class="px-4 py-1 rounded-lg w-fit bg-purple-800 hover:opacity-90 duration-200 text-sm text-white flex items-center gap-1">Download
            CV <ion-icon class="w-4 h-4 animate-bounce" name="arrow-down-circle-outline"></ion-icon></button>
        </a>
      </div>
      <picture>
    ...
    <section class="mt-20 flex flex-col gap-8 justify-center">
      <div class="text-center">
        <h3 class="font-bold text-xl mb-2 text-[#42446E] dark:text-gray-200">My Tech Stack</h3>
    ...
    <section class="mt-20">
      <!-- projects -->
      <div class="text-center">
        <h3 class="font-bold text-xl text-[#42446E] dark:text-gray-200">Projects</h3>
      </div>
