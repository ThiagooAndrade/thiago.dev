...
const themeModeClass = computed(() =>  {
  return {
    ...
    paragraphColor: themeMode.value.isDarkMode ? "text-gray-200" : "text-black"
  }
});
...
<template>
  <section class="mt-20">
    <div class="container px-4 md:px-8 lg:px-16">
      <span class="block h-[1px] bg-gray-500"></span>
      <div class="py-4 flex justify-between">
        <div class="flex gap-4">
          <a :href="links.github" class="animate-pulse">
          ...
          <a :href="links.linkedin" class="animate-pulse">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p class="text-black dark:text-gray-200">Desenvolvido por Thiago 2024</p></div>
    </div>
  </section>
</template>