...
let info = {
  githubUrl: "https://github.com/ThiagooAndrade",
  linkedinUrl: "https://www.linkedin.com/in/thiagoo-andrade/"
}
...
<template>
  <header class="container p-4 md:px-8 lg:px-16 justify-between flex relative">
    ...
    <nav class="flex gap-4 md:gap-8 items-center">
      ...
      <div class="hidden sm:flex gap-2 md:gap-4 justify-center items-center">
        <a :href="info.githubUrl" class="animate-pulse">
